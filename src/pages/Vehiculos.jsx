        ...
        <div>
            ...
            <div id="cardBody" className="card">
                ...
                <ul id="propiertiesList" className="list-group list-group-flush">
                    <li className="list-group-item"><h3>NOMBRE:</h3>{vehiculo?.name}</li>
                    <li className="list-group-item"><h3>MODELO:</h3>{vehiculo?.model}</li>
                    <li className="list-group-item"><h3>PASAJEROS:</h3>{vehiculo?.passengers}</li>
                </ul>
                <div id="addFavs" className="card-body">
                    <a onClick={() => misFavoritos(dispatch, vehiculo.name, store)} href="#" className="card-link"><i class="fa-regular fa-star"></i></a>
